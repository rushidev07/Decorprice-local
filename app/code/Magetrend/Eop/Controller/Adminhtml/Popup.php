...
/**
 * Exit offer popups abstract controller
 *
 * @category MageTrend
 * @package  Magetend/Eop
 * @author   Edvinas Stulpinas <edwin@magetrend.com>
...
class Popup extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Exit Offer / Manage Popups'));
    ...
    {
        return $this->_authorization->isAllowed('Magetrend_Eop::popup');
    }
}
