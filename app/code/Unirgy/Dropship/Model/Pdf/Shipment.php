...
class Shipment extends PdfShipment
{
    ...
    {
        return \Magento\Framework\App\ObjectManager::getInstance()->get(\Magento\Framework\App\Filesystem\DirectoryList::class);
    }

    /**
     * @return \Magento\Shipping\Model\CarrierFactory
     */
    protected function _carrierFactory()
    {
        return \Magento\Framework\App\ObjectManager::getInstance()->get(\Magento\Shipping\Model\CarrierFactory::class);
    }
    ...
    {
        return \Magento\Framework\App\ObjectManager::getInstance()->get(\Unirgy\Dropship\Helper\Data::class);
    }
    ...
    protected function insertOrder(&$page, $order, $putOrderId = true)
    {
        ...
        $page->drawText(__('Order Date: ') . $this->_hlp()->getCreatedAtStoreDate($order, \IntlDateFormatter::MEDIUM, false), 35, ($top -= 30), 'UTF-8');
        if (!empty($po)) {
            $page->drawText(__('Purchase Order Date: ') . $this->_hlp()->getCreatedAtStoreDate($po, \IntlDateFormatter::MEDIUM, false), 135, $top, 'UTF-8');
        }
     ...
     */
    protected function _localeResolver()
    {
        return \Magento\Framework\App\ObjectManager::getInstance()->get(\Magento\Framework\Locale\Resolver::class);
    }
}
