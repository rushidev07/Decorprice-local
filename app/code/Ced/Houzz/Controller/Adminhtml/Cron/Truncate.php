...
namespace Ced\Houzz\Controller\Adminhtml\Cron;
...
class Truncate extends \Magento\Backend\App\Action
{
     ...
     * @param \Ced\Houzz\Helper\Order $helper
     */
    ...
    public function execute()
    {
        try {
            ...
            $this->messageManager->addSuccess(__('Logs Record Delete Succesfully'));
            return $this->_redirect('houzz/cron/crongrid');
        } catch (\Exception $e) {
            $this->messageManager->addErrorMessage(__('Logs Not Deleted, Please Check Error'));
            $this->_redirect('houzz/cron/crongrid');
        }
    }
