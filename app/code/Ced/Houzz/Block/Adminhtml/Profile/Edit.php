 ...
 */
namespace Ced\Houzz\Block\Adminhtml\Profile;
    ...
    protected function _construct()
    {
        ...
        $this->_formScripts[] = "
            function saveAndContinueEdit(urlTemplate,flag) {
                ...
                new Insertion.Bottom('edit_form',  groupVendorPpcode_massactionJsObject.fieldTemplate(
                        {
