...
class OfficeCategory extends \Ced\Houzz\Helper\Product\Base
{
    /**
    ...
    public function setData(
        ...
        if (!empty($product) && !empty($attributes) && !empty($category)) {
            switch ($category['ca_id']) {
                case 'Office' : {
                    $data['Office'] = $this->setOffice($product, $attributes);
                    break;
                }
            }
        }
    ...
    /**
     * Insert OfficeCategory/Office Category Data
     * @param string|array() $product
     * @param string|array() $attributes
     * @return string|array()
     */
    public function setOffice($product = array(), $attributes = array())
    {
        $houzzAttr = array(
