...
namespace Ced\Houzz\Model\Source\Category;
...
class Rootlevel implements \Magento\Framework\Option\ArrayInterface
{
    ...
    /*public function toOptionArray()
    {
        ...
        $collection=$this->objectManager->create('Ced\Houzz\Model\Categories')
            ->getCollection();
        $options = [];
        foreach ($collection as $value) {
            $options[]=[
                'value'=>$value->getCatId(),
                'label'=>$value->getCategoryName()
            ];
        }
        return $options;
    }*/
