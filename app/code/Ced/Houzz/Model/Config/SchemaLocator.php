...
class SchemaLocator extends \Magento\Config\Model\Config\SchemaLocator
{
    		...
    		\Magento\Framework\Module\Dir\Reader $moduleReader)
    {
    	...
    	if($this->_objectManager->get('Magento\Framework\Module\Manager')->isEnabled('Ced_Houzz'))
    	{
	        $etcDir = $moduleReader->getModuleDir(\Magento\Framework\Module\Dir::MODULE_ETC_DIR, 'Ced_Houzz');
