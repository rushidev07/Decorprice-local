...
class CmsPageView implements ObserverInterface
{
    ...
    {
        $iframe = '';
        $iframe .= '<iframe id="embedded-iframe-container-iframe" class="embedded-iframe ws-stores-view" style="width: 100%" width="100%" frameborder="0" allowfullscreen allow="geolocation" scrolling="yes" ';
