...
Note: Composer installation only available for internal use for the moment as the repository are not public. However, there is a work around that will allow you to install the product via composer, described in the article below: https://support.weltpixel.com/hc/en-us/articles/115000216654-How-to-use-composer-and-install-Pearl-Theme-or-other-WeltPixel-extensions
...
Version 1.12.14, Jul 24, 2025  
-Improved the iframe resizer behavior across all embedded pages.  
-Introduced compatibility with the latest Magento 2.4.8-p1, 2.4.7-p6, 2.4.6-p11 and 2.4.5-p13.  
-Improved security code standards.  

Version 1.12.13, Jun 24, 2025  
-Resolved a potential issue where the checkout process could hang or enter an infinite loop when placing orders using payment methods with authorize and capture.  

Version 1.12.12, May 28, 2025  
-Improved the iframe resizer to maintain reliable communication between WeSupply and the host pages where its content is embedded.  

Version 1.12.11, May 21, 2025  
-Magento Compatibility: Introduced compatibility with the new Magento 2.4.8 release, as well as the accompanying 2.4.7-p5, 2.4.7-p4, 2.4.7-p3, 2.4.7-p2 and 2.4.7-p1 Security Patches.  
-Added Norton Shopping Guarantee integration – Boosts customer confidence by protecting purchases from checkout through delivery. Learn more: https://norton.buysafe.com/  

Version 1.12.10, November 25, 2024  
