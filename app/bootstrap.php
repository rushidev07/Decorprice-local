...
/**
 * SourceGuardian stub for local dev — sg_load() is provided by the SourceGuardian PHP extension.
 * Without the extension installed, SourceGuardian-encoded files fail on load.
 * This stub allows those files to be included without crashing; they will define no classes.
 */
if (!function_exists('sg_load')) {
    function sg_load($data) { return false; }
}
